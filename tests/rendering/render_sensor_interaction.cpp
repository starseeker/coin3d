...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_sensor_interaction(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_sensor_interaction) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_sensor_interaction, "render_sensor_interaction"), 0);
}

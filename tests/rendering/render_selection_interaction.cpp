...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_selection_interaction(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_selection_interaction) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_selection_interaction, "render_selection_interaction"), 0);
}

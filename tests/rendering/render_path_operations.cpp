...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_path_operations(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_path_operations) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_path_operations, "render_path_operations"), 0);
}

...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_engine_converter(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_engine_converter) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_engine_converter, "render_engine_converter"), 0);
}

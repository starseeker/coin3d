...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_nodekit_interaction(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_nodekit_interaction) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_nodekit_interaction, "render_nodekit_interaction"), 0);
}

...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_ext_selection(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_ext_selection) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_ext_selection, "render_ext_selection"), 0);
}

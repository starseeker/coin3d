...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_glrender_action_modes(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_glrender_action_modes) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_glrender_action_modes, "render_glrender_action_modes"), 0);
}

...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_pick_filter(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_pick_filter) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_pick_filter, "render_pick_filter"), 0);
}

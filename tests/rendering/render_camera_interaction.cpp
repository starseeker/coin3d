...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_camera_interaction(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_camera_interaction) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_camera_interaction, "render_camera_interaction"), 0);
}

...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_shader_program(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_shader_program) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_shader_program, "render_shader_program"), 0);
}

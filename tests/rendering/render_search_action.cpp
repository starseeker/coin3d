...
// main
// ---------------------------------------------------------------------------
static int obol_run_render_render_search_action(int argc, char **argv)
{
    initCoinHeadless();
...
TEST(RenderingCoverage, render_search_action) {
    EXPECT_EQ(ObolTest::runRenderingCase(obol_run_render_render_search_action, "render_search_action"), 0);
}

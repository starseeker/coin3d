 ...
 * Motivation
 * ----------
 * When building with OBOL_DUAL_GL_BUILD=ON, both the system-OpenGL variant
 ...
 *
 * A thin OBOL_DUAL_GL_BUILD dispatch wrapper (also in gl.cpp) keeps the
...
#define SoGLContext_glFinish                       SOGL_ADD_PREFIX(SoGLContext_glFinish)
#define SoGLContext_glGetError                     SOGL_ADD_PREFIX(SoGLContext_glGetError)

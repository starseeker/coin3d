...
#ifdef _DEBUG
#define COIN_SYSTEM_LIBRARY_NAME "libCoin-osmesa.so.80.0.5"
#else
#define COIN_SYSTEM_LIBRARY_NAME "libCoin-osmesa.so.80.0.5"
#endif
...
/* define if you have OSMesa for offscreen rendering */
...
#define OPENGL_SYSTEM_LIBRARY_NAME ""
...
#define PACKAGE_STRING "Coin 4.0.5"
...
#define SIM_TIMEVAL_TV_SEC_T 

/* define for choosing correct variable size */
#define SIM_TIMEVAL_TV_USEC_T 
